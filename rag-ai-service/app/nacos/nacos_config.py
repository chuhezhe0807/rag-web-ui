...
def _register_watcher(client: NacosConfigService) -> None:
...
def _unregister_watcher(client: NacosConfigService) -> None:
    try:
...
def stop_nacos_config(client: Optional[NacosConfigService]) -> None:
